...
abstract class yvmbase
{
  ...
  yvmbase()
  {
    ...
    RegisterFunction(RegisterPortMessage_MSGID,_On_RegisterPortMessage);
    RegisterFunction(UnregisterPortMessage_MSGID,_On_UnregisterPortMessage);
    RegisterFunction(AddListenerMessage_MSGID,_On_AddListenerMessage);
    RegisterFunction(RemoveListenerMessage_MSGID,_On_RemoveListenerMessage);
    RegisterFunction(SetStatusMessage_MSGID,_On_SetStatusMessage);
    RegisterFunction(UnsetStatusMessage_MSGID,_On_UnsetStatusMessage);
  }
